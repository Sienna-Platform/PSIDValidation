...
threebus_rawfile_dir = "pscad_3bus/ThreeBusPSCAD_MB.raw" #Change to location of raw file 
system_name = "pscad_3bus/ThreeBusVSM_Droop.json"     #Path to save system
include(joinpath(pwd(),"pscad_3bus/dynamic_test_data.jl"))    #Change to location of dynamic test data
