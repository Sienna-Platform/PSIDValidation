...
using Sundials
using CSV
system_file = "pscad_3bus/ThreeBusVSM_Droop.json"        #System from build_system.jl script 
...
recorded_states = [("generator-101-1",:ω_oc),  ("generator-102-1",:θ_oc), ("generator-101-1",:vd_pll ),  ("generator-101-1",:vq_pll ),  ("generator-101-1",:ε_pll ),  ("generator-101-1",:θ_pll )] 
...
elseif perturbation_type == "LineTrip"
        perturbation = BranchTrip(0.1, Line,  "BUS 1-BUS 2-i_2")
else
...
open(joinpath(pwd(), "pscad_3bus", "data", string("psid_outputs_", perturbation_type, "_", line_type)), "w") do io
    CSV.write(io, df)
end  
